...
def dict_feature_group_diff():
    
    categories_list, dict_feature_category = categories.categories_list_and_dict()
...
def get_top_n_sentences_diference_by_group(df, df_similar_different_label, cols_diff, n = 10):
    
    differences_df  = get_top_n_sentences_diference(df, df_similar_different_label, cols_diff, n)
    
    diff_groups_list, dict_feature_group = dict_feature_group_diff()
